...
const ViewLoans = () => {
  ...
  const handleViewCustomer = (customerId, customerName, loanId) => {
    ...
    setSelectedLoanId(loanId); // Add this line after creating a new state variable
    setIsModalOpen(true);
  };
      ...
      <div className="bg-gray-50 p-3 rounded-lg mb-4">
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="p-2 bg-white rounded shadow">
            ...
            <p className="text-lg font-semibold">₹{reportData.totalInterestEarned.toLocaleString()}</p>
          </div>
          <div className="p-2 bg-white rounded shadow">
          ...
          <table className="w-full border-collapse">
            ...
            <tbody className="divide-y divide-gray-200">
              {filteredLoans.length === 0 ? (
                <tr>
                  <td colSpan="7" className="px-4 py-4 text-center text-sm text-gray-500">No loans found</td>
                </tr>
              ) : (
